// But : Le programme à comme entrée un nombre de 5 chiffres, il verifie que celui-ci comprend bien 5 chiffres et l'affiche verticalement
...
{// bloc instruction exécuté si la condition est vraie
	...
	std::cout << nombre / 10 % 10; //l'opérateur demande de diviser le nombre par 10 modulo 10pour afficher le chiffre des dizaine
